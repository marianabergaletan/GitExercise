		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Routing and Navigation Exercise",
									"targetURL": "#zbtpnavigation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpnavigation-display": {
								"semanticObject": "zbtpnavigation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.navigation",
									"url": sap.ui.require.toUrl("zbtp/navigation")
								}
							}
						}
					}
